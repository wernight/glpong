...
private:
  ...
  std::array<Particle, kRocketFireCount> part_spark_;    // Particle Array (Rocket's propulsion sparks)
  std::array<Particle, kExplosionPinkCount> part_pink_;  // Explosion's pink particles
  std::array<Particle, kExplosionPinkCount*kExplosionFireCount> part_fire_;  // Fire generated by the pink particles
